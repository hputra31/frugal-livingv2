...
<body class="gradient-bg-landing text-gray-800">
    ...
    <header id="main-header" class="absolute top-0 left-0 w-full z-30 py-6 px-4 sm:px-6 lg:px-8 transition-all duration-300">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <a href="app.html" class="animated-gradient-btn bg-gradient-to-r from-cyan-600 to-teal-600 text-white font-semibold py-2 px-4 sm:px-6 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                Masuk Aplikasi
            </a>
        </div>
    </header>
    ...
    <main class="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
            <h2 class="text-4xl md:text-6xl font-extrabold mb-4 leading-tight opacity-0">
                Kelola Keuangan dengan <span class="bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent animated-text-breathe">Cerdas</span>
            </h2>
            ...
            <a href="#pricing" class="inline-block bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-600 hover:to-emerald-700 text-white font-bold py-3 px-8 text-base md:py-4 md:px-10 md:text-lg rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 opacity-0">
    ...
    <section id="features" class="py-20">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 fade-in-section">
                ...
                <div class="w-24 h-1 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full mx-auto mt-4"></div>
            </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 flex justify-center">
                <div class="bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/30 max-w-lg w-full text-center fade-in-section relative overflow-hidden" style="transition-delay: 200ms;">
                    <div class="absolute top-7 -right-10 transform rotate-45 bg-gradient-to-r from-red-500 to-orange-500 text-white text-center font-bold py-2 w-48 shadow-lg z-10">
                        Diskon 50%
                    </div>
                    <span class="inline-block bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-sm font-bold px-4 py-1 rounded-full mb-6">AKSES LIFETIME</span>
                    <div class="mb-6 relative">
                        <div class="flex items-end justify-center gap-3">
                            <span class="text-3xl md:text-4xl font-semibold text-gray-400 line-through">Rp 50.000</span>
                            <span class="text-5xl md:text-6xl font-extrabold text-teal-600 animate-pulse">Rp 25.000</span>
                        </div>
                    ...
                    <!-- ❗ Ganti 62... dengan nomor WhatsApp Anda -->
                    <a href="https://wa.me/6289674135929?text=Halo%2C%20saya%20tertarik%20dengan%20penawaran%20diskon%20lifetime%20Rp%2025.000%20untuk%20aplikasi%20Frixsave." target="_blank" class="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-3 px-8 text-base md:py-4 md:px-10 md:text-lg rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white/70 backdrop-blur-lg rounded-2xl p-8 shadow-lg border border-white/30 fade-in-section group">
                    <div class="flex items-center mb-4">
                        <div class="w-16 h-16 rounded-full mr-4 border-2 border-teal-200 shadow-md bg-gradient-to-br from-cyan-100 to-teal-200 flex items-center justify-center">
                            <i class="fas fa-user text-3xl text-teal-500"></i>
                        </div>
                        <div>
    ...
    <section id="cta" class="py-20">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative bg-gradient-to-r from-cyan-600 to-teal-700 rounded-3xl p-8 md:p-12 text-center shadow-2xl fade-in-section overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-cyan-100 max-w-2xl mx-auto mb-8">
                        Dapatkan akses lifetime hanya dengan sekali bayar. Mulai perjalanan finansial Anda yang lebih baik hari ini!
                    </p>
                    <!-- ❗ Ganti 62... dengan nomor WhatsApp Anda -->
                    <a href="https://wa.me/6289674135929?text=Halo%2C%20saya%20tertarik%20dengan%20penawaran%20diskon%20lifetime%20Rp%2025.000%20untuk%20aplikasi%20Frixsave." target="_blank" class="bg-white hover:bg-gray-100 text-green-600 font-bold py-3 px-8 text-base md:py-4 md:px-10 md:text-lg rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
    ...
    <footer class="py-8">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p class="text-gray-600">
                &copy; 2025 Frixsave by <span class="font-semibold bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">HPUTRAX</span>.
            </p>
        </div>
    </footer>

    <!-- Back to Top Button -->
    <a href="#" id="back-to-top" class="fixed bottom-4 right-4 md:bottom-8 md:right-8 w-12 h-12 bg-teal-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-teal-700 transition-all duration-300 opacity-0 pointer-events-none">
