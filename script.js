        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 flex justify-center">
                <div class="bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/30 max-w-lg w-full text-center fade-in-section relative overflow-hidden" style="transition-delay: 200ms;">
                    <div class="absolute top-7 -right-10 transform rotate-45 bg-gradient-to-r from-pink-500 to-red-500 text-white text-center font-bold py-2 w-48 shadow-lg z-10">
                        Diskon 50%
                    </div>
                    ...
                    <div class="mb-6 relative">
                        <div class="flex items-end justify-center gap-3">
                            ...
                            <span class="text-5xl md:text-6xl font-extrabold text-indigo-600 animate-pulse">Rp 25.000</span>
                        </div>
